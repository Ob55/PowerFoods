...
export interface Product {
  ...
  /** "Why This Skill Matters", 1 to 2 short paragraphs. */
  whyItMatters?: string;
...
export const products: Product[] = [
  {
    ...
    faqs: [
      ...
      { q: "How long does the course take?", a: "Most students watch all the videos in one focused session of 2 to 3 hours, then revisit lessons as needed." },
  ...
  },
  {
    ...
    price: 59.99,
    image: "/products/square-shape.jpg",
    ...
    benefits: [
      ...
      "Two-grip cuticle cutting (90° and 45°) in 1 to 1.5mm steps",
    ...
    heroVideoSrc: "/videos/square-shape.mp4",
    heroPoster: "/videos/square-shape-poster.jpg",
    idealLearner:
