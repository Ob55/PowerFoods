...
export const guideContent: Record<string, GuideEntry[]> = {
  "healthy-eating": [
    ...
    },
    {
      ...
      content:
        "Fibre is the part of plants you don't fully digest, and it's one of the most under-eaten nutrients. Soluble fibre (oats, beans, apples) helps steady blood sugar and lower cholesterol, while insoluble fibre (whole grains, vegetable skins) keeps digestion regular. Most adults fall short of the recommended ~25 to 30g a day. Choose whole grains over refined, keep skins on produce, and add beans and lentils to reach it comfortably.",
    },
    {
  ...
  "better-sleep": [
    ...
    },
    {
      ...
      content:
        "Sleep naturally changes with age: it often becomes lighter and more easily interrupted, and timing may shift earlier. Needing 7 to 9 hours doesn't disappear, but getting it can take more attention to habits and daytime light and activity. Waking occasionally is normal; persistent problems are not just 'old age' and are worth discussing with a professional. Consistent routines matter even more over time.",
    },
    {
  ...
  "mental-wellness": [
    ...
    },
    {
      ...
      content:
        "The food and mood connection is real. Steady blood sugar from balanced meals helps avoid the irritability of crashes, and the gut produces much of the body's serotonin, so gut-friendly eating may support mood. Patterns rich in vegetables, fish, whole grains and healthy fats are linked with better mental wellbeing, while heavy ultra-processed diets are linked with worse. Enough water, and not too much alcohol or caffeine, help too.",
    },
    {
